...
<body>
    ...
    <div class="container">
        <div class="article">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur asperiores dolorem ab animi. Aspernatur et sed quae at qui ut excepturi ducimus, labore molestias minus ea non incidunt consectetur adipisci?</p>
        </div>
        <div class="article">
            <img src="images/php.png" alt="">
            <p class="p"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, similique! Cumque ducimus veritatis, labore nostrum nisi odit? Accusantium ullam, incidunt, quis soluta aliquam, minus molestiae quidem fugit aliquid neque ex.
            </p>
        </div>
        <div class="article">
            <img src="images/mysql.png"  class="img" alt="">
            <p class="p1"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium illo, aspernatur asperiores omnis aperiam in! Neque, suscipit aut, possimus perferendis deserunt libero illum blanditiis, explicabo facere architecto quam pariatur voluptatibus.</p>
        </div>
        <div class="article">
